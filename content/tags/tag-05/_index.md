...
This is an expanded sample body for **tag_term** entry **open-question**. It is intentionally verbose so you can review spacing, hierarchy, and readability at multiple screen sizes.
...
| Slug | tag-05 | Useful for traceability in previews |
