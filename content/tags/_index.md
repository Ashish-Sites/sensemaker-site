...
This is an expanded sample body for **entry** entry **Tags**. It is intentionally verbose so you can review spacing, hierarchy, and readability at multiple screen sizes.
...
| Slug | tags | Useful for traceability in previews |
