...
This is an expanded sample body for **tag_term** entry **framework**. It is intentionally verbose so you can review spacing, hierarchy, and readability at multiple screen sizes.
...
| Slug | tag-01 | Useful for traceability in previews |
