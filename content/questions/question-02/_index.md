...
title: "What assumptions am I making without evidence?"
description: "Sample question_term entry for rendering validation across cards, tables, and detail layouts. It keeps dense phrasing, varied punctuation, and readable structure to stress wrapping, truncation, and ty"
lifecycle: active
draft: false
---
...
This is an expanded sample body for **question_term** entry **What assumptions am I making without evidence?**. It is intentionally verbose so you can review spacing, hierarchy, and readability at multiple screen sizes.
...
| Field | Example | Notes |
|---|---|---|
| Type | question_term | Demonstrates table alignment and borders |
| Slug | question-02 | Useful for traceability in previews |
