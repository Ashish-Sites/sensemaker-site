...
title: "What can be simplified without losing value?"
...
This is an expanded sample body for **question_term** entry **What can be simplified without losing value?**. It is intentionally verbose so you can review spacing, hierarchy, and readability at multiple screen sizes.
...
| Slug | question-10 | Useful for traceability in previews |
