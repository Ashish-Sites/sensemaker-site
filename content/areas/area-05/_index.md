...
This is an expanded sample body for **area_term** entry **Product Thinking**. It is intentionally verbose so you can review spacing, hierarchy, and readability at multiple screen sizes.
...
| Slug | area-05 | Useful for traceability in previews |
