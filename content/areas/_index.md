...
This is an expanded sample body for **entry** entry **Areas**. It is intentionally verbose so you can review spacing, hierarchy, and readability at multiple screen sizes.
...
| Slug | areas | Useful for traceability in previews |
