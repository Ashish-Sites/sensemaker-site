...
primary_area: "Knowledge Management"
lifecycle: active
draft: false
---
...
This is an expanded sample body for **topic_term** entry **Note-making Workflows**. It is intentionally verbose so you can review spacing, hierarchy, and readability at multiple screen sizes.
...
| Slug | topic-08 | Useful for traceability in previews |
