...
This is an expanded sample body for **entry** entry **Topics**. It is intentionally verbose so you can review spacing, hierarchy, and readability at multiple screen sizes.
...
| Slug | topics | Useful for traceability in previews |
